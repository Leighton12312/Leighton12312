...
if platform.system() == 'Windows':
    os.system('cls & title .gg/Replace here')  
elif platform.system() == 'Linux':
    os.system('clear') 
    sys.stdout.write("\x1b]0;.gg/Replace here'\x07")  
elif platform.system() == 'Darwin':
    os.system("clear && printf '\e[3J'")  
    os.system('''echo "\033]0;.gg/Replace here\007"''')  
...
@bot.slash_command(guild_ids=[config["guildID"]], name="paypal", description="View the servers paypal.")
async def paypal(ctx):
    await ctx.respond(embed = discord.Embed(title = "**PayPal**", description = f"https://paypal.me/teamcold?country.x=GB&locale.x=en_GB", color = 0x4598d2))


@bot.slash_command(guild_ids=[config["guildID"]], name="bitcoin", description="View our bitcoin address.")
async def bitcoin(ctx):
    await ctx.respond(embed = discord.Embed(title = "**BitCoin**", description = f"SOON", color = 0x4598d2))



@bot.slash_command(guild_ids=[config["guildID"]], name="litecoin", description="View our litecoin address.")
async def litecoin(ctx):
    await ctx.respond(embed = discord.Embed(title = "**LiteCoin**", description = f"SOON", color = 0x4598d2))
...
async def stock(ctx):
    ...
    return await ctx.respond(embed = discord.Embed(title = "**Stock**", description = f"<a:1907nitroboostinglevel:1112311808062144542>**3 Months Tokens Stock:** {three}\n**3 Months Boosts Stock:** {three*2}\n\n**1 Month Tokens Stock:** {one}\n**1 Month Boosts Stock:** {one*2}", color = 0x4598d2))
